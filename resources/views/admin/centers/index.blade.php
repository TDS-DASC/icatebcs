          ...
          <div class="card">
            <div class="card-header">
              <div class="col">
                ...
                @can('Agregar centros')
                  <button type="button" id="add" class="btn btn-success float-end"
                          data-bs-toggle="modal" data-bs-target="#modalCentro"
                          @click="createCenter('')"><i class="ri-add-line align-bottom me-1"></i>
                    Agregar
                  </button>
                @endcan
              </div>
          ...
          <div class="card h-100" style="">
            ...
            <div class="card-body pt-3">
              <div class="col team-settings">
                <div class="row">
                  <div class="col text-end dropdown dropdownTopCard">
                    <button class="btn btn-sm btn-light dropdown btnOptionsDropdownTopCard"
                            type="button" data-bs-toggle="dropdown" aria-expanded="false">
                      <i class="ri-more-2-fill ri-xl align-middle"></i>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end" style="">
                      <li><a class="dropdown-item cursorPointer"
                             :href="'{{ url('center') }}'+'/'+center.id"><i
                              class="ri-eye-line me-2 align-bottom text-muted"></i>Detalles</a>
                      </li>
                      @can('Editar centros')
                        <li><a class="dropdown-item cursorPointer" id="edit"
                               data-bs-toggle="modal" data-bs-target="#modalCentro"
                               @click="editCenter(center.id)"><i
                                class="ri-pencil-line me-2 align-bottom text-muted"></i>Editar</a>
                        </li>
                      @endcan
                      @can('Eliminar centros')
                        <li><a class="dropdown-item cursorPointer"
                               @click="destroyCenter(center.id)"><i
                                class="ri-delete-bin-5-line me-2 align-bottom text-muted"></i>Eliminar</a>
                        </li>
                      @endcan
                    </ul>
                  </div>
              ...
              <div class="text-start">
                <a :href="'{{ url('center') }}'+'/'+center.id"><h4 class="card-title mb-1"
                                                                   style="color: #495057">
              ...
              <div class="d-flex gap-1 mb-1">
                <i class="ri-government-fill"></i>Direción: @{{center.address.colonia}},
                @{{center.address.calle}}, @{{center.address.codigo_postal}}
                @{{center.address.city.name}}, @{{center.address.city.state.name}}
              </div>
              <div class="d-flex gap-1 mb-1">
              ...
              <div class="d-flex gap-2 mb-1">
                <i class="ri-user-2-fill"></i>Posición del director:<p class="text-muted mb-0">
                  @{{center.director_position}}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <form class="flex flex-col w-full" :action="url" method="POST" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                <div class="col-xxl-6">
                  <div>
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                           ...
                           onkeypress="return letrasYNumeros(event)" :value="center.name"
                ...
                <div class="col-xxl-6">
                  <div>
                    ...
                    <input type="text" class="form-control" id="short_name" name="short_name"
                           ...
                           onkeypress="return letrasYNumeros(event)" :value="center.short_name"
                           maxlength="100" required>
                    @error('short_name')
                    <div class="alert alert-borderless alert-danger" role="alert">
                      <strong>{{$message}}</strong>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="d-flex justify-content-between">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="center_type"
                             id="accionMovil" value="Accion movil" v-model="center.center_type"
                             required>
                      <label class="form-check-label" for="accionMovil"><p>Acción móvil</p>
                      </label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="center_type"
                             id="unidadCapacitacion" value="Unidad de Capacitacion"
                             v-model="center.center_type" required>
                      <label class="form-check-label" for="unidadCapacitacion">Unidad de
                        capacitación</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="center_type"
                             id="direccionGeneral" value="Direccion General"
                             v-model="center.center_type" required>
                      <label class="form-check-label" for="direccionGeneral">Dirección
                        general</label>
                    </div>
                  </div>
                  @error('center_type')
                ...
                <div class="col-xxl-12">
                  <div>
                    <label for="director_name" class="form-label">Nombre del Director(a)
                      General</label>
                    <input type="text" class="form-control" id="director_name" name="director_name"
                           placeholder="Ingrese el nombre del director"
                           onkeypress="return soloLetras(event)" :value="center.director_name"
                           maxlength="100" required>
                    @error('director_name')
                    <div class="alert alert-borderless alert-danger" role="alert">
                      <strong>{{$message}}</strong>
                ...
                <div class="col-xxl-6">
                  <div>
                    ...
                    <select name="director_position" class="form-select" style="display: block" required>
                      <option disabled value="" selected>Seleccione la posición</option>
                      <option value="Director" :value="center.director_position">Director(a)</option>
                      <option value="Encargado" :value="center.director_position">Encargado(a)</option>
                    </select>
                ...
                <div class="col-xxl-6">
                  <div>
                    ...
                    <input type="text" class="form-control" id="telephone_number"
                           name="telephone_number" placeholder="Ingrese un número teléfonico"
                           onkeypress="return soloNumeros(event)" :value="center.telephone_number"
                ...
                <div class="col-xxl-12">
                  <div>
                    ...
                    <input type="file" id="cover_path" name="cover_path" class="form-control"
                           accept="image/*" data-max-size="1507459" filename="cover.jpg">
                  </div>
                </div><!--end col-->
                <div class="">
                ...
                <div class="col-xxl-12">
                  <div>
                    ...
                    <input type="text" class="form-control" id="calle" name="calle"
                           placeholder="Ingrese la calle" :value="center.address.calle"
                ...
                <div class="col-xxl-6">
                  <div>
                    ...
                    <input type="text" class="form-control text-uppercase" id="numero" name="numero"
                           placeholder="Ingrese el número" onkeypress="return soloNumeros(event)"
                           :value="center.address.numero" maxlength="10" required>
                    @error('numero')
                    <div class="alert alert-borderless alert-danger" role="alert">
                      <strong>{{$message}}</strong>
                    </div>
                ...
                <div class="col-xxl-6">
                  <div>
                    ...
                    <input type="text" class="form-control" id="colonia" name="colonia"
                           ...
                           onkeypress="return letrasYNumeros(event)" :value="center.address.colonia"
                           maxlength="100" required>
                    @error('colonia')
                    <div class="alert alert-borderless alert-danger" role="alert">
                      <strong>{{$message}}</strong>
                ...
                <div class="col-xxl-4">
                  <div>
                    ...
                    <input type="text" class="form-control" id="codigo_postal" name="codigo_postal"
                           ...
                           :value="center.address.codigo_postal" maxlength="5" minlength="5"
                           required>
                    @error('codigo_postal')
                    <div class="alert alert-borderless alert-danger" role="alert">
                      <strong>{{$message}}</strong>
                ...
                <div class="col-xxl-4">
                  <div>
                    ...
                    <select class="form-select" name="city_id" :value="center.address.city_id"
                            required>
